...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 27, 2025 at 04:47 AM
...
--
-- Database: `u277316404_erestro_testin`
--
...
CREATE TABLE `cities` (
  ...
  `min_order_amount_for_free_delivery` double DEFAULT NULL,
...
CREATE TABLE `favorites` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `type` varchar(20) DEFAULT NULL COMMENT 'restaurants | products',
...
CREATE TABLE `orders` (
  ...
  `promocode_type` varchar(50) DEFAULT NULL COMMENT 'default | partner	',
  `promo_discount` double DEFAULT NULL,
  `discount` double DEFAULT 0,
  `final_total` double DEFAULT NULL,
  `is_pos_order` int(11) NOT NULL DEFAULT 0 COMMENT '0|1',
  ...
  `is_rider_otp_setting_on` int(11) DEFAULT NULL,
  ...
  `order_items_snapshot` longtext NOT NULL,
...
CREATE TABLE `order_items` (
  ...
  `partner_detail_snapshot` longtext DEFAULT NULL,
  `date_added` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `partner_data` (
  ...
  `licence_name` varchar(2048) NOT NULL,
  `licence_code` varchar(2048) NOT NULL,
  `licence_proof` varchar(2048) NOT NULL,
  `licence_status` tinyint(2) NOT NULL,
  `global_restaurant_time` tinyint(4) NOT NULL DEFAULT 1,
  `date_added` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `promo_codes` (
  `id` int(11) NOT NULL,
  `promo_code` mediumtext NOT NULL,
  `message` varchar(512) DEFAULT NULL,
  `start_date` varchar(28) DEFAULT NULL,
  `end_date` varchar(28) DEFAULT NULL,
  `promocode_type` varchar(30) NOT NULL DEFAULT 'default',
  `partner_id` int(11) NOT NULL,
...
(6, 'system_settings', '{\"system_configurations\":\"1\",\"system_timezone_gmt\":\"+05:30\",\"system_configurations_id\":\"13\",\"app_name\":\"eRestro\",\"support_number\":\"9876543210\",\"support_email\":\"support@erestro.com\",\"current_version\":\"1.0.0\",\"current_version_ios\":\"2.0.3.2\",\"is_version_system_on\":\"1\",\"currency\":\"\\u20b9\",\"system_timezone\":\"Asia\\/Kolkata\",\"is_refer_earn_on\":\"0\",\"tax\":\"1\",\"is_email_setting_on\":\"0\",\"google_map_api_key\":\"Google Map API KEY (For Application\",\"google_map_javascript_api_key\":\"Maps JavaScript API KEY\",\"min_refer_earn_order_amount\":\"\",\"refer_earn_bonus\":\"\",\"refer_earn_method\":\"\",\"max_refer_earn_amount\":\"\",\"refer_earn_bonus_times\":\"\",\"minimum_cart_amt\":\"50\",\"low_stock_limit\":\"5\",\"max_items_cart\":\"12\",\"is_rider_otp_setting_on\":\"0\",\"is_app_maintenance_mode_on\":\"1\",\"cart_btn_on_list\":\"0\",\"expand_product_images\":\"0\"}'),
...
CREATE TABLE `users` (
  ...
  `max_commission` double DEFAULT NULL COMMENT 'used for riders only when commission method is percentage',
  ...
  `serviceable_city` text DEFAULT NULL,
  `apikey` text DEFAULT NULL,
  `referral_code` varchar(32) DEFAULT NULL,
  `friends_code` varchar(28) DEFAULT NULL,
  `platform` varchar(10) DEFAULT NULL COMMENT 'android|ios',
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `email`, `mobile`, `type`, `image`, `balance`, `rating`, `no_of_ratings`, `activation_selector`, `activation_code`, `forgotten_password_selector`, `forgotten_password_code`, `forgotten_password_time`, `remember_selector`, `remember_code`, `created_on`, `last_login`, `active`, `company`, `address`, `commission_method`, `commission`, `max_commission`, `cash_received`, `dob`, `country_code`, `city`, `area`, `street`, `pincode`, `serviceable_city`, `apikey`, `referral_code`, `friends_code`, `platform`, `fcm_id`, `web_fcm_id`, `latitude`, `longitude`, `created_at`) VALUES
(1, '127.0.0.1', 'Administrator', '$2y$12$To.YZSanlojW8u0GE.bl6.DFBNWPbPpyOMdyzmJZbtGk6hgceEm/2', 'admin@gmail.com', '9876543210', 'phone', NULL, 0, 0.0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1268889823, 1748002670, 1, 'ADMIN', NULL, NULL, 0.00, NULL, 0.00, NULL, 91, NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'dJXa6kH3Tzm6NBGwON5fhe:APA91bEFYijAUaRSRliyj0JXMTFm7SRGtXBFWoIOwH8f7VwkdG5xy0JsUpBH8sqO-_dGGZFxkP1oocj3kpKh-gOfkVDsaiqUYE_lunE7dlCqec9W-iL4kda6vO7qtOn7pFsAk6D2qLwza', NULL, '23.233278401061945', '69.64415181576143', '2020-06-30 10:20:08');
